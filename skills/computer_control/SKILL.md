...
- `shell_execute(command, timeout=20)`: ينفذ أمرًا في طرفية الحاوية المعزولة (ليس مضيف المستخدم) مع حماية موارد صارمة (CPU 30s، ذاكرة 512MB، ملفات 64، timeout). لا تستخدمه لتثبيت برمجيات ضارة أو للوصول للشبكة إلا لأغراض المهمة.
