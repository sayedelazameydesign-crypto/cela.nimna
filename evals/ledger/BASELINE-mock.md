...
**Repo:** `e6ef918` · **Tasks:** `11` · **Generated:** `2026-09-23T17:53:18+00:00` · **run_command:** `enabled`
...
| `code-01-fizzbuzz-module` | coding | 🧪 **MOCKED** | 100.0 | 6/6 | mock provider run — deterministic checks only · verifier PASS · fs: Δ1 cb0a7629ae1a→c9425def3b7f ev:569c34ed64f97b28 |
...
| `code-05-shell-fix-retry` | coding | 🧪 **MOCKED** | 100.0 | 5/5 | mock provider run — deterministic checks only · verifier PASS · fs: Δ1 fb681ae9c774→02f57fc9b5e6 ev:6e815f76457b5a8c |
...
**Metrics:** verified `4/9` · tool calls `5` (failed `0`) · shell executions `3` (failed commands `1`) · security denials `0` · evidence completeness `100.0`% · recovered `1` · mean wall `15.0`ms
