...
**Repo:** `2beb5f0` · **Tasks:** `11` · **Generated:** `2026-09-23T18:07:10+00:00` · **run_command:** `enabled`
...
| `code-01-fizzbuzz-module` | coding | 🧪 **MOCKED** | 100.0 | 6/6 | mock provider run — deterministic checks only · verifier PASS · fs: Δ1 cb0a7629ae1a→c9425def3b7f ev:565382e3497d3217 · ckpt COMPLETED:c57d4f71b3b2 |
...
| `code-05-shell-fix-retry` | coding | 🧪 **MOCKED** | 100.0 | 5/5 | mock provider run — deterministic checks only · verifier PASS · fs: Δ1 fb681ae9c774→02f57fc9b5e6 ev:294b084935733698 · ckpt COMPLETED:450717e589b7 |
...
**Metrics:** verified `4/9` · tool calls `5` (failed `0`) · shell executions `3` (failed commands `1`) · security denials `0` · evidence completeness `100.0`% · recovered `1` · mean wall `15.1`ms
