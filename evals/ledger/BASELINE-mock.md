...
**Repo:** `5a91256` · **Tasks:** `11` · **Generated:** `2026-09-23T17:28:29+00:00` · **run_command:** `enabled`
...
| `code-01-fizzbuzz-module` | coding | 🧪 **MOCKED** | 100.0 | 2/2 | mock provider run — deterministic checks only |
...
| `code-05-shell-fix-retry` | coding | 🧪 **MOCKED** | 100.0 | 2/2 | mock provider run — deterministic checks only |
...
**Metrics:** verified `4/9` · tool calls `5` (failed `0`) · shell executions `3` (failed commands `1`) · security denials `0` · evidence completeness `100.0`% · recovered `1` · mean wall `15.3`ms
