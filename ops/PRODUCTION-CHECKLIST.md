...
| 7 | `docker build --pull` للمرشح | خطوة 7 — **لا تخطي** | **CI فقط** (لا docker هنا — البوابة حمراء بصدق محلياً) |
| 8 | CI `production-gate` أخضر على GitHub | تشغيل الـworkflow على هذا الفرع | بانتظار أول دفعة |
