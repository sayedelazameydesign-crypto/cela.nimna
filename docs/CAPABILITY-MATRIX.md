...
| MCP gateway | partial | `nimna/mcp/` (contract, headers, transport, gateway) | contract + policy + audit proven offline; not wired into the agent loop; no live server (MOCKED) | `mcp` |
